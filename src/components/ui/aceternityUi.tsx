  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 w-full">
        <div className="flex flex-col items-center justify-center h-full text-center group-hover/canvas-card:-translate-y-4 transition duration-200">
          <div>{icon}</div>
        ...
        <div className="text-center text-xl font-bold text-white opacity-0 group-hover/canvas-card:opacity-100 relative z-10 mt-2 group-hover/canvas-card:-translate-y-2 transition duration-200">
          {description}
        </div>
      </div>
    </div>
